...
describe('Controller: reservation period directive', function () {
  ...
  it ('should save the bookingPeriod', function () {
    scope.availabilityEnds = moment(new Date('02/09/2016')).hours(23).minutes(59).seconds(59).format();
    scope.availabilityStarts = moment(new Date('02/07/2016')).hours(0).minutes(0).seconds(0).format();
