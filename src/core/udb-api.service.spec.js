...
describe('Service: UDB3 Api', function () {
  ...
  it('should find offers when provided a query', function (done) {
    var response = {};
    $httpBackend
      .expectGET(baseUrl + 'offers/?q=foo:bar&sort[created]=desc&start=0&disableDefaultFilters=true&embed=true&workflowStatus=READY_FOR_VALIDATION,APPROVED')
      .respond(JSON.stringify(response));
    service
      .findOffers('foo:bar')
  ...
  it('should find offers when provided no query', function (done) {
    var response = {};
    $httpBackend
      .expectGET(baseUrl + 'offers/?disableDefaultFilters=true&embed=true&sort[created]=desc&start=0&workflowStatus=READY_FOR_VALIDATION,APPROVED')
      .respond(JSON.stringify(response));
    service
      .findOffers('')
