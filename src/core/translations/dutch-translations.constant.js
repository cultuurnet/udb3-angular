...
angular.module('udb.core')
  .constant('udbDutchTranslations',
  {
    ...
    eventTypes: {
      ...
      'Festival': 'Festival',
      'Movie': 'Film',
      'Camp or holidays': 'Kamp of vakantie',
      'Fun fair or festivities': 'Kermis of feestelijkheden',
      'Lecture or congres': 'Lezing of congres',
      'Market or fare': 'Markt of braderie',
      'Open house': 'Opendeurdag',
      'Party': 'Party of fuif',
      'Route': 'Route',
      'Game or quiz': 'Spel of quiz',
      'Sports and movement': 'Sport en beweging',
      'Watch sports game': 'Sportwedstrijd bekeijken',
      'Exhibition': 'Tentoonstelling',
      'Theater performance': 'Theatervoorstelling'
    },
    eventThemes: {
      'Architecture': 'Architectuur',
      'Heritage': 'Erfgoed',
      'History': 'Geschiedenis',
      'Art and art education': 'Kunst en kunsteducatie',
      'Agriculture and countryside': 'Landbouw en platteland',
      'Multiple art forms': 'Meerdere kunstvormen',
      'Environment and nature': 'Milieu en natuur',
      'Society': 'Samenleving',
      'Science': 'Wetenschap',
      'Meaning, philosophy and religion': 'Zingeving,filosofie en religie',
      'Antique and brocante': 'Antiek en brocante',
      'Health and wellness': 'Gezondheid en wellness',
      'Literature': 'Literatuur',
      'Comics': 'Strips',
      'Food': 'Voeding',
      'Entertainment music': 'Amusementsmuziek',
      'Dance': 'Dance',
      'Folk and world music': 'Folk en wereldmuziek',
      'Hip hop, r&b and rap': 'Hip hop, r&b en rap',
      'Jazz and blues': 'Jazz en blues',
      'Classical music': 'Klassieke muziek',
      'Pop and rock': 'Pop en rock',
      'Ballet and classical dance': 'Ballet en klassieke dans',
      'Modern dance': 'Moderne dans',
      'Ballroom dance': 'Stijl en salondansen',
      'Folk dance and world dance': 'Volksdans en werelddans',
      ...
      'Athletics walking and cycling': 'Atletiek wandelen en fietsen',
      'Ball and racket sport': 'Bal en raketsport',
      'Fitness gymnastics dance and fighting sport': 'Fitness gymnastiek dans en vechtssport',
      'Air and motor sport': 'Lucht en motorsport',
      'Omnisport and others': 'Omnisport en andere',
      'Outdoor and adventure': 'Outdoor en adventure',
      'Folk sports': 'Volkssporten',
      'Swimming and water sport': 'Zwemmen en watersport',
      'Intercultural education': 'Interculturele vorming',
      'Education': 'Opvoeding',
      'Person and relationships': 'Persoon en relaties',
      'Humor and comedy': 'Humor en comedy',
      'Multiple film genres': 'Meerdere filmgenres',
      'Action and adventure': 'Actie en avontuur',
      'Animation and kids films': 'Animatie en kinderfilms',
      'Cinefile': 'Cinefiel',
