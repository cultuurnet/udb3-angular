  ...
  .constant('udbDutchTranslations',
  {
    ...
    eventForm: {
      ...
      step5: {
        ...
        'empty': 'Leegmaken',
        'tips': {
          'Concert': '<p>Geef een enthousiaste omschrijving van het concert.</p> <ul> <li>Welk(e)<strong> artiest(en)</strong> treden op? </li> <li>Welk <strong>genre</strong> is het?</li><li>Welk<strong> album</strong> <strong>of werk </strong>wordt voorgesteld? </li></ul>',
          'Dansvoorstelling': '<p>Geef een enthousiaste omschrijving van de dansvoorstelling.</p><ul><li>Wie is de <strong>choreograaf</strong>?</li><li>Wie zijn de<strong> dansers</strong>?</li><li>In welke <strong>stijl</strong> dansen ze?</li><li>Over welk <strong>thema of onderwerp</strong> gaat de voorstelling?</li></ul>',
          'Festival': '<p>Geef een enthousiaste omschrijving van het festival. </p> <ul> <li>Wie of wat staat er op het <strong>programma?</strong> </li> <li>Welke <strong>(rand)animatie</strong> is er?</li> </ul>',
          'Film': '<p>Geef een enthousiaste omschrijving van de film. </p> <ul> <li>Schets kort het <strong>verhaal</strong>. </li> <li>Wie is de <strong>regisseur?</strong> </li> <li>Wie zijn de  <strong>hoofdrolspelers?</strong> </li> <li>Heeft de film <strong>prijzen</strong> gewonnen? </li></ul>',
          'Lezing of congres': '<p>Geef een enthousiaste omschrijving van de lezing of het congres. </p> <ul> <li>Welke<strong> thema’s</strong> komen aan bod? </li><li>Welke <strong>sprekers </strong>nemen het woord?</li></ul>',
          'Theatervoorstelling': '<p>Geef een enthousiaste omschrijving van de voorstelling. </p> <ul> <li>Schets kort het <strong>verhaal</strong> of het <strong>thema</strong>. </li> <li>Welk <strong>theatergezelschap</strong> brengt het stuk? </li> <li>Welke <strong>acteurs</strong> spelen mee?</li></ul>',
          'Sportwedstrijd bekijken': '<p>Geef een enthousiaste omschrijving van de sportwedstrijd. </p> <ul> <li>Welke <strong>ploegen of deelnemers</strong> spelen er mee? </li> <li>In welke<strong> competitie</strong> kadert de wedstrijd?</li></ul>',
          'Markt of braderie': '<p>Geef een enthousiaste omschrijving van de markt of braderie. </p> <ul> <li>In <strong>welke straten</strong> vindt ze plaats? </li> <li>Welke <strong>kramen of standjes</strong> zullen er zijn? </li><li>Is er <strong>(rand)animatie</strong>?</li></ul>',
          ...
          'Tentoonstelling': '<p>Geef een enthousiaste omschrijving van de tentoonstelling. </p> <ul> <li>Welke <strong>kunstenaars</strong> stellen tentoon?</li> <li>Welke<strong> collecties</strong> kan je bekijken? </li> <li>Is er een <strong>(audio)gids</strong> of <strong>brochure</strong> beschikbaar?</li></ul>',
          ...
          'Lessenreeks': '<p>Geef een enthousiaste omschrijving van de lessenreeks. </p> <ul> <li>Wat leer je er precies? </li> <li>Is er <strong>voorkennis</strong> nodig om deel te nemen? </li> <li>Wat is het <strong>niveau</strong> van de lessen? </li><li>Krijg je op het einde een <strong>diploma</strong> of certificaat?</li></ul>',
          ...
          'Festiviteit': '<p>Geef een enthousiaste omschrijving van de kermis. </p> <ul> <li>Welke <strong>attracties</strong> zijn er? </li> <li>Zijn er<strong> (rand)activiteiten</strong> (quiz, concerten, foodtrucks, marktje ...)?</li> </ul>',
