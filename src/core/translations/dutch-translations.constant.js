...
angular.module('udb.core')
  .constant('udbDutchTranslations',
  {
    ...
    eventTypes: {
      'Guided tour': 'Begeleide rondleiding',
      'Fair': 'Beurs',
      'Concert': 'Concert',
      'Course or workshop': 'Cursus of workshop',
      'Dance performance': 'Dansvoorstelling',
      'Food and drinks': 'Eten en drinken',
      'Festival': 'Festival',
      'Film': 'Film',
      'Camping': 'Kamp of vakantie',
      'Fair or celebration': 'Kermis of feestelijkheden',
      'Lecture or conference': 'Lezing of congres',
      'Market or bazaar': 'Markt of braderie',
      'Open house': 'Opendeurdag',
      'Party or nightlife': 'Party of fuif',
      'Cycling or hiking tour': 'Route',
      'Game or quiz': 'Spel of quiz',
      'Sports activity': 'Sportactiviteit',
      'Sports Viewing': 'Sportwedstrijd bekijken',
      'Exhibition': 'Tentoonstelling',
      'Theatre': 'Theatervoorstelling',
      ...
      'School or education center': 'School of onderwijscentrum',
    ...
    eventThemes: {
      ...
      'Arts education': 'Kunst en kunsteducatie',
      'Agriculture': 'Landbouw en platteland',
      'Multiple art forms': 'Meerdere kunstvormen',
      'Environment and nature': 'Milieu en natuur',
      'Society': 'Samenleving',
      'Science': 'Wetenschap',
      'Philosophy and religion': 'Zingeving,filosofie en religie',
      'Antiques': 'Antiek en brocante',
      'Health and wellness': 'Gezondheid en wellness',
      'Literature': 'Literatuur',
      'Comics': 'Strips',
      'Nutrition': 'Voeding',
      'Cabaret music': 'Amusementsmuziek',
      'Dance': 'Dance',
      'Folk and world music': 'Folk en wereldmuziek',
      'Hip hop, rnb and rap': 'Hip hop, r&b en rap',
      'Jazz and blues': 'Jazz en blues',
      'Classical music': 'Klassieke muziek',
      'Pop and rock': 'Pop en rock',
      'Classical dance and ballet': 'Ballet en klassieke dans',
      'Modern dance': 'Moderne dans',
      'Ballroom dancing': 'Stijl en salondansen',
      'Folk dance': 'Volksdans en werelddans',
      'Audiovisual art': 'Audiovisuele kunst',
      'Sculpture': 'Beeldhouwkunst',
      'Circus': 'Circus',
      'Creativity': 'Creativiteit',
      'Decorative art': 'Decoratieve kunst',
      'Design': 'Design',
      ...
      'Text and music theater': 'Tekst- en muziektheater',
      'Athletics, running and cycling': 'Atletiek, wandelen en fietsen',
      'Ball and racket sports': 'Bal en raketsport',
      'Fitness, gymnastics, dance and martial arts': 'Fitness gymnastiek dans en vechtssport',
      'Air and motor sports': 'Lucht en motorsport',
      'Other sports': 'Omnisport en andere',
      'Outdoor and adventure': 'Outdoor en adventure',
      'Folklore sports': 'Volkssporten',
      'Swimming and water sports': 'Zwemmen en watersport',
      'Cross-cultural education': 'Interculturele vorming',
      'Education': 'Opvoeding',
      'People and society': 'Persoon en relaties',
      'Comedy': 'Humor en comedy',
      'Multiple film genres': 'Meerdere filmgenres',
      'Action and adventure': 'Actie en avontuur',
      'Animation and children\'s films': 'Animatie en kinderfilms',
      'Independent': 'Cinefiel',
      'Documentaries and reports': 'Documentaires en reportages',
      'Drama': 'Drama',
      'Musical film': 'Filmmusical',
      'Horror film': 'Griezelfilm of horror',
      ...
      'Computer and technology': 'Computer en techniek',
      'Health and care': 'Gezondheid en zorg',
      'Economy': 'Economie',
      'Installation art': 'Installatiekunst',
      'Puppetry': 'Figuren en poppentheater',
      'Mime': 'Mime en bewegingstheater',
      'Theatre and Musical theatre': 'Tekst en muziektheater',
