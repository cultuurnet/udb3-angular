  ...
  .constant('udbFrenchTranslations',
  {
    ...
    eventForm: {
      ...
      step5: {
        ...
        'empty': 'Vider',
        'tips': {
          'Concert': '<p>Donnez une description enthousiaste du concert.</p> <ul> <li>Quel(s) <strong>artiste(s)</strong> se produisent?</li> <li>De quel <strong>genre</strong> s\'agit-il?</li> <li>Quel <strong>album ou œuvre</strong> sera présenté?</li> </ul>',
          'Dansvoorstelling': '<p>Donnez une description enthousiaste du spectacle de danse.</p> <ul> <li>Qui est le <strong>chorégraphe</strong>?</li> <li>Qui sont les <strong>danseurs</strong>?</li> <li>Dans quel <strong>style</strong> dansent-ils?</li> <li>Quel est le <strong>thème ou le sujet</strong> de la représentation?</li> </ul>',
          'Festival': '<p>Donnez une description enthousiaste du festival.</p> <ul> <li>Qui ou quoi est au <strong>programme</strong>?</li> <li>Quelle est l\'<strong>animation</strong> (périphérique)?</li> </ul>',
          'Film': '<p>Donnez une description enthousiaste du cinéma.</p> <ul> <li>Faites une brève description de <strong>l\'histoire</strong>.</li> <li>Qui est le <strong>réalisateur</strong>?</li> <li>Qui sont les <strong>protagonistes</strong>?</li> <li>Le film a-t-il remporté des <strong>prix</strong>?</li> </ul>',
          'Lezing of congres': '<p>Donnez une description enthousiaste de la conférence où congrès</p> <ul> <li>Quels <strong>thèmes</strong> sont couverts?</li> <li>Quels <strong>orateurs</strong> prennent la parole?</li> </ul>',
          'Theatervoorstelling': '<p>Donnez une description enthousiaste du théâtre.</p> <ul> <li>Esquissez brièvement <strong>l\'histoire</strong> ou le <strong>thème</strong>.</li> <li>Quelle<strong> compagnie de théâtre</strong> jouera la pièce?</li> <li>Quels sont les <strong>acteurs</strong> qui jouent?</li> </ul>',
          'Sportwedstrijd bekijken': '<p>Donnez une description enthousiaste de la compétition sportive.</p> <ul> <li>Quelles <strong>équipes</strong> ou <strong>quels participants </strong>jouent?</li> <li>Dans quelle <strong>compétition</strong> se déroule la compétition?</li> </ul>',
          'Markt of braderie': '<p>Donnez une description enthousiaste du marché, foire ou fête foraine</p> <ul> <li>Dans <strong>quelles rues </strong>a-t-il lieu?</li> <li>Quels seront les <strong>stands</strong> ou les <strong>stands de vente</strong>?</li> <li>Y a-t-il une <strong>animation</strong> (de bord)?</li> </ul>',
          'Opendeurdag': '<p>Donnez une description enthousiaste de la journée portes ouvertes. Que pouvez-vous <strong>voir</strong> ou <strong>vivre</strong>?</p>',
          'Beurs': '<p>Donnez une description enthousiaste de la foire. Que pouvez-vous <strong>voir</strong>, <strong>vivre</strong> ou <strong>acheter</strong>?</p>',
          'Tentoonstelling': '<p>Donnez une description enthousiaste de l\'exposition.</p> <ul> <li>Quels sont les <strong>artistes</strong> qui exposent?</li> <li>Quelles <strong>collections</strong> pouvez-vous consulter?</li> <li>Existe-t-il un <strong>guide (audio)</strong> ou une <strong>brochure</strong>?</li> </ul>',
          'Begeleide rondleiding': '<p>Donnez une description enthousiaste de la visite guidée.</p> <ul> <li>Qu\'y a-t-il à <strong>voir</strong> ou à <strong>vivre</strong> le long du parcours?</li> <li>Y a-t-il un <strong>nombre</strong> maximum de <strong>participants</strong>?</li> <li>La visite guidée est-elle organisée en continu ou à des moments précis?</li> <li>Y a-t-il des <strong>points d\'attention</strong> particuliers (par exemple, des bottes indiquées)?</li> </ul>',
          'Lessenreeks': '<p>Donnez une description enthousiaste de la série de cours.</p> <ul> <li>Qu\'y apprenez-vous exactement?</li> <li>Des <strong>connaissances préalables</strong> sont-elles nécessaires pour participer?</li> <li>Quel est le <strong>niveau</strong> des cours?</li> <li>Recevez-vous un <strong>diplôme</strong> ou un certificat à la fin?</li> </ul>',
          'Cursus met open sessies': '<p>Donnez une description enthousiaste du cours avec sessions ouvertes ou workshop.</p> <ul> <li>Qu\'y apprenez-vous exactement?</li> <li>Des <strong>connaissances préalables</strong> sont-elles nécessaires pour participer?</li> <li>Quel est le <strong>niveau</strong> des cours?</li> <li>Recevez-vous un <strong>diplôme</strong> ou un certificat à la fin?</li> </ul>',
          'Kamp of vakantie': '<p>Donnez une description enthousiaste du camp de vacances</p> <ul> <li>Quelles <strong>activités</strong> pouvez-vous y faire?</li> <li>Y a-t-il un <strong>thème</strong>?</li> <li>Est-il <strong>avec ou sans nuitées</strong>?</li> <li>Quelle est <strong>l\'heure de début</strong> <strong>et de fin</strong> des camps de jour et les soins sont-ils <strong>fournis</strong> avant et après?</li> </ul>',
          'Festiviteit': '<p>Donnez une description enthousiaste de la festivité</p> <ul> <li>Quelles sont les <strong>attractions</strong>?</li> <li>Y a-t-il des <strong>activités (périphériques)</strong>: quiz, concerts, food trucks, marché,...?</li> </ul>',
          'Route': '<p>Donnez une description enthousiaste de l\'itinéraire.</p> <ul> <li>Faites-vous le <strong>trajet à pied, en vélo, en bateau</strong>,..?</li> <li>Quels sont les <strong>arrêts possibles</strong>?</li> <li>Quelle est la <strong>distance</strong> ou la <strong>durée</strong> de l\'itinéraire?</li> <li>L\'itinéraire est-il <strong>accompagné</strong>, avec un guide, une brochure ou des panneaux indicateurs?</li> </ul>',
          'Party of fuif': '<p>Donnez une description enthousiaste de la soirée. Quels <strong>deejays</strong> ou <strong>groupes</strong> se produisent?</p>',
          'Eet of drankfestijn': '<p>Donnez une description enthousiaste du festin de nourriture ou de boisson.</p> <ul> <li>Qu\'y a-t-il au <strong>menu</strong>?</li> <li>Les <strong>recettes</strong> seront-elles versées à une <strong>organisation caritative</strong>?</li> <li>Y a-t-il une <strong>animation (périphérique)</strong>?</li> </ul>',
          'Spel of quiz': '<p>Donnez une description enthousiaste du quiz ou du jeu.</p> <ul> <li>Sur quels <strong>sujets</strong> porte le quiz?</li> <li>Le jeu a-t-il un <strong>thème</strong>?</li> <li>Y a-t-il quelque chose à <strong>gagner</strong>?</li> <li>Y a-t-il un <strong>nombre maximum de participants</strong>?</li> </ul>',
          'Sport en beweging': '<p>Donnez une description enthousiaste de l\'activité sportive.</p> <ul> <li>Quel(s) <strong>sport(s)</strong> pouvez-vous pratiquer?</li> <li>Quel <strong>matériel</strong> est (non) fourni?</li> </ul>',
          'Monument': '<p>Donnez ici une description saillante du monument. Indiquez également si l\'ouverture du monument est limitée (p.ex. seulement des salons).</p>'
        },
