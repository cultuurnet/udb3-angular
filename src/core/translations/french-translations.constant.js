...
angular.module('udb.core')
  .constant('udbFrenchTranslations',
  {
    ...
    eventTypes: {
      'Guided tour': 'Tour ou excursion guidé',
      'Fair': 'Foire / exposition',
      'Concert': 'Concert',
      'Course or workshop': 'Cours ou atelier',
      'Dance performance': 'Spectacle de danse',
      'Food and drinks': 'Manger et boire',
      'Festival': 'Festival',
      'Film': 'Film',
      'Camping': 'Camp de vacance',
      'Fair or celebration': 'Foire ou festivité',
      'Lecture or conference': 'Conférence ou congrès',
      'Market or bazaar': 'Marché ou braderie',
      'Open house': 'Journée portes ouvertes',
      'Party or nightlife': 'Soirée',
      'Cycling or hiking tour': 'Randonnée pédestre ou cycliste',
      'Game or quiz': 'Jeu ou quiz',
      'Sports activity': 'Activité sportive',
      'Sports Viewing': 'Assister à une compétition sportive',
    ...
    eventThemes: {
      ...
      'Heritage': 'Patrimoine',
      'History': 'Histoire',
      'Arts education': 'Arts et formation artistique',
      'Agriculture': 'Agriculture et campagne',
      'Multiple art forms': 'Arts multiples',
      'Environment and nature': 'Environnement et nature',
      'Society': 'Vivre en société',
      'Science': 'Science',
      'Philosophy and religion': 'Sense de la vie, philosophie et religion',
      'Antiques': 'Antiquités ou brocantes',
      'Health and wellness': 'Santé et bien-être',
      'Literature': 'Litérature',
      'Comics': 'Bandes dessinés',
      'Nutrition': 'Nutrition',
      'Cabaret music': 'Amusementsmuziek',
      'Dance': 'Dance',
      'Folk and world music': 'Musique folklorique et mondiale',
      'Hip hop, rnb and rap': 'Hip hop, rnb et rap',
      'Jazz and blues': 'Jazz et blues',
      'Classical music': 'Musique classique',
      'Pop and rock': 'Pop et rock',
      'Classical dance and ballet': 'Ballet et danse classique',
      'Modern dance': 'Danse moderne',
      'Ballroom dancing': 'Danse de salon et stylée',
      'Folk dance': 'Danse folklorique et mondiale',
      'Audiovisual art': 'Arts audiovisuels',
      'Sculpture': 'Sculpture',
      'Circus': 'Cirque',
      'Creativity': 'Créativité',
      'Decorative art': 'Arts décoratives',
      'Design': 'Design',
      'Photography': 'Photographie',
      'Graphics': 'Art grafique',
      'Fashion': 'Mode',
      'Poetry': 'Poésie',
      'Painting': 'Peinture',
      'Text and music theater': 'Théâtre dramatique et musical',
      'Athletics, running and cycling': 'Athlétisme, marche et cyclisme',
      'Ball and racket sports': 'Sports au ballons et raquettes',
      'Fitness, gymnastics, dance and martial arts': 'Fitness, gymnastique, danse et arts martiaux',
      'Air and motor sports': 'Sports aero et moteurs',
      'Other sports': 'Omnisports et autres',
      'Outdoor and adventure': 'Plein air et aventure',
      'Folklore sports': 'Sports folkloriques',
      'Swimming and water sports': 'Natation et sports nautiques',
      'Cross-cultural education': 'Formation interculturelle',
      'Education': 'Éducation',
      'People and society': 'Hommes et relations',
      'Comedy': 'Comédie',
      'Multiple film genres': 'Films de tous genres',
      'Action and adventure': 'Action et aventure',
      'Animation and children\'s films': 'Films animés et films pour enfants',
      'Independent': 'Cinéphile',
      'Documentaries and reports': 'Documentaires et reportages',
      'Drama': 'Films dramatiques',
      'Musical film': 'Comédie musicale',
      'Horror film': 'Films d\'épouvantes ou orreurs',
      'Historical film': 'Films historiques',
      'Comedy film': 'Comédie',
      'Short film': 'Court métrage',
      'Science fiction': 'Science fiction',
      'Thriller': 'Films à suspense',
      'Technology': 'Technologie',
      'Computer and technology': 'Ordinateurs et technologie',
      'Health and care': 'Santé et soins',
      'Economy': 'Économie',
      'Installation art': 'Art d\'installation',
      'Puppetry': 'Théâtre de marionnettes',
      'Mime': 'Mime et theéâtre de mouvements',
      'Theatre and Musical theatre': 'Théâtre dramatique et musical',
      'Opera en operetta': 'Opéra et opérette'
    },
    eventThemesGroups: {
      'Dance': 'Danser',
      'Art and heritage': 'Art et Patrimoine',
      'Music': 'Musique',
      'Sport': 'Sports',
    ...
    placeTypes: {
      ...
      'Library or documentation center': 'Bibliothèque ou centre de documentation',
      'Cinema': 'Cinéma',
      'Culture- or meeting center': 'Centre de culture ou de réunion',
      'Disco': 'Discothèque',
      'Catering industry': 'Horeca',
      'Youth home or youth center': 'Maison de jeunes ou centre de jeunesse',
      'Monument': 'Monument',
      'Museum or gallery': 'Musée ou galerie',
      'Nature, park or garden': 'Nature, parc ou jardin',
      'Public space': 'Espace public',
      'Recreation domain or center': 'Domaine de loisirs',
      'School or education center': 'École ou centre éducatif',
      'Sport center': 'Centre sportif',
      'Theme or amusement park': 'Thème ou parc d\'attractions',
      'Shop': 'Magasin',
      'Room or exhibition hall': 'salle d\'exposition'
    }
  }
);
