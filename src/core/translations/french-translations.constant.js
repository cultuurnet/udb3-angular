    ...
    eventForm: {
      ...
      step5: {
        ...
        'tips': {
          ...
          'Eet of drankfestijn': 'Donnez une description enthousiaste du festin de nourriture ou de boisson. Qu\'y a-t-il au menu? Les recettes seront-elles versées à une organisation caritative? Y a-t-il une animation (périphérique)?',
          'Spel of quiz': 'Donnez une description enthousiaste du quiz ou du jeu. Sur quels sujets porte le quiz? Le jeu a-t-il un thème? Y a-t-il quelque chose à gagner? Y a-t-il un nombre maximum de participants?',
          'Sport en beweging': 'Donnez une description enthousiaste de l\'activité sportive. Quel(s) sport(s) pouvez-vous pratiquer? Quel matériel est (non) fourni?',
