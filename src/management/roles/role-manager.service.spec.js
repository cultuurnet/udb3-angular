...
describe('Service: Role Manager', function () {
  ...
  it('should add a constraint of a role', function(done) {
    ...
    service
        .createRoleConstraint('0823f57e-a6bd-450a-b4f5-8459b4b11043', 'andere constraint')
        .then(assertAPICall);
  ...
  it('should remove the constraint of a role', function(done) {
    ...
    function assertAPICall() {
      expect(udbApi.removeRoleConstraint).toHaveBeenCalledWith('0823f57e-a6bd-450a-b4f5-8459b4b11043');
      done();
    }

    service
        .removeRoleConstraint('0823f57e-a6bd-450a-b4f5-8459b4b11043')
        .then(assertAPICall);
